    ...
    <section ref={sectionRef} className="py-24 bg-secondary/30 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="border-none shadow-xl bg-card/80 backdrop-blur transition-all hover:-translate-y-2 reveal animate-delay-200">
          ...
          <Card className="border-none shadow-2xl bg-primary text-primary-foreground transition-all hover:-translate-y-2 scale-105 z-20 reveal animate-delay-400">
          ...
          <Card className="border-none shadow-xl bg-card/80 backdrop-blur transition-all hover:-translate-y-2 reveal animate-delay-600">
            <CardContent className="p-8 text-center">
        ...
        <div className="mt-16 max-w-6xl mx-auto overflow-hidden rounded-3xl shadow-xl h-96 relative reveal animate-delay-800">
          {!mapLoaded && (
